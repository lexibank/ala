...
# python3 -u ala-ff-torch.py --database=lexibank -experiment
# python3 -u ala-ff-torch.py --database=asjp -experiment
#python3 -u ala-ff-torch.py --database=grambank -experiment
#python3 -u ala-ff-torch.py --database=combined -experiment
